...
internal class view_horizontal_interface(
    ...
    override fun updateView(info: update_info){
        if (info.dataset != null){
            ...
            this.Title_text.isDisable = false
            this.X_Axis_text.isDisable = false
            this.Y_Axis_text.isDisable = false
        } else {
            this.Title_text.text = ""
            this.X_Axis_text.text =""
            this.Y_Axis_text.text = ""
            this.Title_text.isDisable = true
            this.X_Axis_text.isDisable = true
            this.Y_Axis_text.isDisable = true
        }
    }
}